...
export default function BasicForm({ handlesavenext,titlebc }) {
    ...
    return  <div className="BasicRightMainDiv2ndDiv">
        ...
        <input className="BasicRightMainDiv2ndDiv1stinput" style={{ borderColor:`${titlebc}` }} type="text" value={title} onChange={ (e)=>{setTitle(e.target.value)}}/>
        ...
        <input className="BasicRightMainDiv2ndDiv2ndinput"  type="file" name="myImage" accept="image/x-png,image/gif,image/jpeg" onChange={ (e)=>{setImage(e.target.value)}}/>
                    ...
                    <input className="BasicRightMaidnDiv2ndDiv3rdinput"  placeholder="Location" type="text" />
                    
                    <h4>Catagory</h4>
                    <h5>To help backers find your campaign, select a category that best represents your project.</h5>
                    <select className="BasicRightMainDiv2ndDivSelect"  name="Select a category" >
                    ...
                    <h4 className="BasicRightMainDiv2ndDivh4" >Campaign Duration<span>*</span></h4>
        ...
        <input className="BasicRightMaidnDiv2ndDiv4thinput"   type="text" value={duration} onChange={ (e)=>{setDuration(e.target.value)}}/>
        ...
        }} className="BasicRightMainDiv2ndDivButton"  >Save & Next</button>
                </div>
}