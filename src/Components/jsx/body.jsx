        ...
        <ParentDiv>
                ...
                <div className="outerdiv">
                    <div className="div1" style={{ marginRight: "200px" }}>
                        <img src="https://entrepreneur.indiegogo.com/how-it-works/wp-content/uploads/sites/5/2017/07/IGG_entrepreneur-site-crowdfunding-50px@2x-e1515528474613.png" alt="crowdfunding" />
                            <h2 className="crowdfunding">CROWDFUNDING</h2>
                        <h4>Raise funds with a crowdfunding</h4>
                        <h4>Acquire starter capital and validate your idea by tapping into Indiegogo’s global network of early adopters.</h4>
                        <br />
                        <br />
                        <br />
                    ...
                    <div className="div1">
                        ...
                        <h4>After your crowdfunding campaign, continue raising money and building your community with InDemand. No fundraising target, no deadline limits.</h4>
                        <br />
                        <br />
                        <br />
                        <p>ACCESS INDEMAND</p>
            ...
            <Div4>
                <div className="success">
                    ...
                    <p>The NOMATIC travel bag is shipping their products worldwide to 7K backers after raising $3M in crowdfunding on Indiegogo.</p>
                </div>
                <div className="success">
                    ...
                    <p>HyperDrive Thunderbolt 3 USB-C Hub for MacBook Pro raised $1M+ on InDemand, by targeting outreach to grow a loyal community of backers.</p>
                </div>
                <div className="success">
                    ...
                    <p>After raising $381K on Indiegogo, BullRest - the reinvented travel pillow - launched on Indiegogo Product Marketplace with guaranteed shipping.</p>
                </div>
            ...
            <Div7>
                <div>
                    ...
                    <p>Take the plunge with our guided campaign-creation tool. It’s free, and you can easily start now and finish later.</p>
                ...
                <div>
                    ...
                    <p>Take your idea further with these experienced companies recommended by Indiegogo campaigners and staff.
                ...
                <div>
                    ...
                    <p>Find everything you need for a successful campaign in one convenient location.</p>
                ...
                <div>
                    ...
                    <p>Learn about the benefits of choosing Indiegogo for your idea. See our detailed breakdown.</p>
                    <h3>GET INFORMED</h3>
