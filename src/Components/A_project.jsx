...
export default function Aproject() {
    ...
    <Navbar />
        ...
        <div className="PromiddleDiv">
            <h4 >Who are you raising money for?</h4>
            ...
            <label  style={{marginTop:-50}} className="label1">Business or Non Profit</label>
        ...
        <div className="ProbottomDiv">
            ...
            <div onClick={() => {
                ...
                <p className="ProbottomDiv2ndp" >{ residence}</p>
            </div>
        ...
        <div className="Probottom1Div">
            ...
            <div onClick={() => {
                ...
                <p className="Probottom2Div1stp" >{ bankCountry}</p>
        </div>
            ...
            <div className="Probottom23Div">
                <h3 >What countries are supported by Indiegogo?</h3>
                <div className="mt-5"></div>
                <p  >You can start a campaign in countries supported by our payment processor. Learn more about potential options if your country is not supported at this time.</p>
            </div>
        </div>
        <Footer />
    </>
